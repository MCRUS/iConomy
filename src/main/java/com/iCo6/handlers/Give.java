...
public class Give extends Handler {
    ...
    public boolean perform(CommandSender sender, LinkedHashMap<String, Argument> arguments) throws InvalidUsage {
        ...
        if(name.equals("0"))
            throw new InvalidUsage("Параметр <white>игрок<rose> не найден: /money give <игрок> <количество>");

        if(arguments.get("amount").getStringValue().equals("empty"))
            throw new InvalidUsage("Параметр <white>количество<rose> не найден: /money give <игрок> <количество>");
